...
function wpultra_ability_files(): array {
    return [
        ...
        // seo (Wave 7, Plan 3)
        'seo-manage-sitemap', 'seo-manage-robots', 'seo-manage-redirects',
    ];
...
function wpultra_ability_category_map(): array {
    return [
        ...
        'seo' => ['seo-status', 'seo-get-meta', 'seo-set-meta', 'seo-analyze-page', 'seo-suggest-internal-links', 'seo-insert-internal-link', 'seo-link-audit', 'seo-keyword-research', 'seo-content-gap', 'seo-competitor-analysis', 'seo-optimize-content', 'seo-manage-sitemap', 'seo-manage-robots', 'seo-manage-redirects'],
    ];
}
...
function wpultra_load_abilities(): void {
    ...
    if (!in_array('seo', $disabled, true)) {
        foreach (['setup', 'meta', 'head', 'analyze', 'links', 'research', 'technical', 'local'] as $sf) {
